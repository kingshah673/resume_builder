...
const PDFDownloadButton = dynamic(() => import("./PDFDownloadButton"), {
    ssr: false,
    loading: () => (
        <button disabled className="px-6 py-2.5 bg-slate-300 text-slate-500 font-medium rounded-lg cursor-not-allowed flex items-center gap-2">
...
export default function PDFWrapper({ data }: { data: any }) {
    if (!data) return null;
